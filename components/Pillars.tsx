...
const pillars = [
  {
    ...
    description: "An AI voice receptionist built by Mergelith answers inbound calls for M&A firms 24/7. It captures buyer and seller intent, qualifies relevance, and books meetings directly into partner calendars, preventing deal leakage from missed calls.",
    icon: (
  ...
  },
  {
    ...
    description: "Mergelith deploys AI chatbots that pre-qualify buyers and sellers before partner involvement. The chatbot gathers key deal information, screens for relevance, and routes only qualified opportunities to partners or associates.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Mergelith designs AI-driven deal intake and pre-screening systems that standardize data capture and accelerate initial deal assessment. These systems eliminate incomplete submissions and ensure consistent qualification.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Mergelith optimizes M&A firm websites for AI-driven search platforms, including Google AI Overviews and ChatGPT Search, so firms are accurately identified, recommended, and cited by AI engines as trusted authorities.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
