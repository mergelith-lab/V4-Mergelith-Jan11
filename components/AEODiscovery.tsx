    ...
    <section id="aeo-discovery" className="scroll-mt-32">
      <div className="flex flex-col lg:flex-row gap-20 items-center">
        <div className="lg:w-1/2 space-y-10">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="flex items-center gap-6 p-6 border border-navy/10 bg-white/60 rounded-sm hover:border-gold/40 transition-all group">
                <div className="w-12 h-12 flex items-center justify-center bg-gold/10 text-gold rounded-full group-hover:bg-gold group-hover:text-pearl transition-all">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <p className="text-base text-navy/80 font-semibold tracking-wide">{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="bg-white border border-navy/10 rounded-sm shadow-xl overflow-hidden">
            <div className="bg-navy/5 border-b border-navy/10 px-8 py-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-3.5 h-3.5 rounded-full bg-navy/10"></div>
                <div className="w-3.5 h-3.5 rounded-full bg-navy/10"></div>
                <div className="w-3.5 h-3.5 rounded-full bg-navy/10"></div>
              </div>
              <div className="text-[11px] text-navy/40 font-mono tracking-[0.2em] font-black">SEARCH_MODE: ANSWER_ENGINE</div>
            </div>
            ...
            <div className="p-10 space-y-10">
              ...
              <div className="flex gap-6">
                <div className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center text-xs text-gold font-black border border-gold/20 shadow-sm">AI</div>
                <div className="flex-1 space-y-6">
                  ...
                  <div className="p-7 border border-gold/20 bg-gold/5 rounded-sm shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <div className="px-4 py-2 bg-navy/5 border border-navy/10 rounded text-[10px] text-navy/40 font-black uppercase tracking-widest">Citation: Market Signal [2]</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-navy/10 flex items-center justify-between">
                <div className="text-[11px] text-navy/30 uppercase tracking-widest font-black">Visibility Index: 100%</div>
                <div className="text-[11px] text-gold font-black tracking-widest uppercase">Mergelith AI Protocol ACTIVE</div>
              </div>
            </div>
          </div>
        </div>
